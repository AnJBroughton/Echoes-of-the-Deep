...
window.WIKI_DATA = {
  campaign: {
    ...
    home: {
      ...
      currentEyebrow: "Current chapter · O Captain my Clack!",
  ...
  entries: [
    ...
    },
    {
      ...
      image: "assets/images/session-31-wayward-gull.jpg?v=20260917",
      ...
      links: ["session-30-only-the-opening-act", "last-breath-reliquary", "drokis-hat", "blue-catapult-stone", "crown-of-the-lesser-tyrant", "wayward-gull", "scroll-of-gale-burst", "scrolls-of-water-walking", "marble-game-set", "phantasmal-heart", "gravesilver-signet"],
      published: true,
    ...
    },
    {
      ...
      status: "Carried",
      title: "Droki’s Hat",
      summary: "A battered memento carried in hopes of finding Droki’s father, Steel Shadow.",
      content: "Taken from Droki after his death. The party keeps the battered hat as proof of what became of him—and as a final memento to deliver if they find his father, Steel Shadow.",
      links: ["session-31-toward-the-tower-of-vengeance"],
      published: true,
      updatedAt: "2026-09-17"
    },
    {
      id: "blue-catapult-stone",
      type: "item",
      category: "equipment",
      holder: "V",
      uses: "Reusable",
      status: "Carried",
      title: "Blue Catapult Stone",
      summary: "A specially prepared blue stone intended for V’s Catapult spell.",
      content: "Previously commissioned or prepared for V, this blue stone was confirmed complete and delivered during the party’s preparations for the Darklake voyage. Its weight and shape make it a ready projectile for Catapult.",
      links: ["session-31-toward-the-tower-of-vengeance"],
      published: true,
      updatedAt: "2026-09-17"
    },
    {
      id: "crown-of-the-lesser-tyrant",
      type: "item",
      category: "equipment",
      holder: "Helexisys",
      uses: "1/long rest",
      status: "Carried",
      title: "Crown of the Lesser Tyrant",
      effect: {
        rarity: "Wondrous treasure",
        text: "Grants advantage on Intimidation checks. Once per long rest, the bearer can frighten a creature within 30 ft."
      },
      summary: "A fearsome crown that magnifies its bearer’s authority and dread.",
      content: "Recovered among Frazzulbu’s treasures and entrusted to Helexisys. The crown carries the oppressive presence of a lesser tyrant, lending unnatural weight to threats and allowing its bearer to overwhelm a nearby creature with fear.",
      links: ["session-30-only-the-opening-act", "session-31-toward-the-tower-of-vengeance"],
      published: true,
      updatedAt: "2026-09-17"
    },
    {
      ...
      uses: "Vessel",
      status: "Active",
      title: "The Wayward Gull",
      effect: {
        rarity: "Darklake vessel · Purchased for 500 gp",
        text: "The fastest of Thymbris’s three vessels. When properly powered by wind, it excels at navigation, riding currents, escaping hazards, and outrunning threats."
      },
      summary: "A swift Darklake vessel captained by Thymbris “Bent Mast” Bramblehorn.",
      content: "Purchased and secured for 500 gp, the Wayward Gull was chosen for speed over safety. With Thymbris returned to its helm and enough wind in its sails, the vessel gives the party their best chance of crossing the Darklake ahead of pursuit.",
      links: ["session-31-toward-the-tower-of-vengeance"],
      published: true,
      updatedAt: "2026-09-17"
    },
    {
      id: "scroll-of-gale-burst",
      type: "item",
      category: "consumable",
      holder: "Biscuit / Party",
      uses: "1 scroll",
      status: "Available",
      title: "Scroll of Gale Burst",
      effect: {
        rarity: "Spell scroll · Purchased for 175 gp",
        text: "Produces a powerful directional blast of wind for up to 1 minute, making it particularly useful for powering the Wayward Gull."
      },
      summary: "A wind-bearing scroll purchased to help drive the Wayward Gull.",
      content: "Purchased for 175 gp during the party’s final preparations in Mantol Derith. The scroll releases a sustained, forceful current of wind and may prove invaluable on the still and treacherous waters of the Darklake.",
      links: ["wayward-gull", "session-31-toward-the-tower-of-vengeance"],
      published: true,
      updatedAt: "2026-09-17"
    },
    {
      id: "scrolls-of-water-walking",
      type: "item",
      category: "consumable",
      holder: "Helexisys / Party",
      uses: "2 scrolls",
      status: "Available",
      title: "2× Scrolls of Water Walking",
      effect: {
        rarity: "Spell scrolls · Gifted",
        text: "Two scrolls capable of granting Water Walking—valuable emergency protection during the party’s Darklake voyage."
      },
      summary: "Two lifesaving spell scrolls gifted for the voyage across the Darklake.",
      content: "The goblin merchant provided these scrolls free of charge after Helexisys asked what preparations the party should make before venturing onto the Darklake.",
      links: ["wayward-gull", "session-31-toward-the-tower-of-vengeance"],
      published: true,
      updatedAt: "2026-09-17"
    },
    {
      ...
      uses: "Reusable",
      status: "Carried",
      title: "Marble Game Set",
      summary: "An elaborate, unidentified marble game purchased from Definitely Not Stolen.",
      content: "Purchased for 50 gp from Definitely Not Stolen. The set resembles an elaborate chess-like game, but every identifying mark and all instructions have been carefully removed, leaving its rules and origin a mystery.",
      links: ["session-31-toward-the-tower-of-vengeance"],
      published: true,
      updatedAt: "2026-09-17"
    },
    ...
    },
    {
      ...
      "image": "assets/images/gravesilver-signet-cover.png?v=20260907",
    ...
    },
  {
    ...
    id: "v-stone-giant-blood-wolf-mask", type: "item", category: "keepsake", holder: "V", uses: "—", status: "Archived", title: "V — Stone Giant / Blood-Wolf Mask",
    ...
    image: "assets/images/gala-masks/v-gala-mask.png?v=full-20260818", links: [], published: true, updatedAt: "2026-08-18"
  }, {
    id: "biscuit-tortle-dragon-mask", type: "item", category: "keepsake", holder: "Biscuit", uses: "—", status: "Archived", title: "Biscuit — Tortle Dragon Mask",
    summary: "A richly carved wooden tortle mask wreathed in flame-like accents.",
    content: "Its realistic tortle features honor Biscuit’s connection to the Wandering Shell Clan. The surrounding flames give it a tortle-dragon quality tied to his fascination with fire and creation.",
    image: "assets/images/gala-masks/biscuits-gala-mask.png?v=full-20260818", links: [], published: true, updatedAt: "2026-08-18"
  }, {
    id: "nari-midnight-star-mask", type: "item", category: "keepsake", holder: "Nari", uses: "—", status: "Archived", title: "Nari — Midnight Star Mask",
    summary: "A smooth black mask that seems shaped from the night sky.",
    content: "A soft starlight glow ebbs from within, as though distant stars shine from behind the face rather than being painted across it.",
    image: "assets/images/gala-masks/nari-gala-mask.png?v=full-20260818", links: [], published: true, updatedAt: "2026-08-18"
  }, {
    id: "helexisys-golden-coin-of-fate", type: "item", category: "keepsake", holder: "Helexisys", uses: "—", status: "Archived", title: "Helexisys — Golden Coin of Fate",
    summary: "A brilliant golden coin mask marked by delicate, intentional fractures.",
    content: "Elegant filigree frames hairline cracks symbolizing the fragile nature of fortune: luck may grant great blessings, yet it can break at any moment. The design reflects Helexisys’s devotion to Lady Luck and the discovery of Quibble’s curse.",
    image: "assets/images/gala-masks/helexis-gala-mask.png?v=full-20260818", links: [], published: true, updatedAt: "2026-08-18"
  }, {
    id: "prince-derendil-quaggoth-mask", type: "item", category: "keepsake", holder: "Derendil", uses: "—", status: "Archived", title: "Prince Derendil — The Quaggoth Mask",
    ...
    },
    {
      ...
      "image": "assets/images/session-29-gala-cover.png?v=20260831",
